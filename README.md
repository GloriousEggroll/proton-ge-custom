...
| <tt>async</tt>      | <tt>DXVK_ASYNC</tt>    | (<b>DISCONTINUED</b> since [GE-Proton7-45](https://github.com/GloriousEggroll/proton-ge-custom/releases/tag/GE-Proton7-45)) Allows Async to be used with DXVK. This can help with stutter in some games, however it is recommended not to be used with games that have sensitive anti-cheats. Use at your own risk. |
